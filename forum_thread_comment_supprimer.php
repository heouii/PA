...
if ($user && $user['role'] === 'admin') {
    if (isset($_GET['id'])) {
        ...
        $q = 'SELECT * FROM forum_thread_comment WHERE id_forum_comment = :id';
        $statement = $bdd->prepare($q);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $q = 'DELETE FROM forum_thread_comment WHERE id_forum_comment = :id';
            $statement = $bdd->prepare($q);
    ...
    <main>
        <div class="container">
            ...
            <div class="alert alert-danger">
                ...
                <p><strong>Thread ID :</strong> <?= $comment['id_forum_thread'] ?></p>
                <p><strong>Auteur :</strong> <?= $comment['id_commentateur'] ?></p>
